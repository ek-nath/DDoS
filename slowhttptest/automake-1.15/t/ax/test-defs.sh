...
am_rel_srcdir='.'
am_top_srcdir='/root/slowhttptest/automake-1.15'
am_top_builddir='/root/slowhttptest/automake-1.15'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/usr/local/share/automake-1.15/am'
    am_automake_acdir='/usr/local/share/aclocal-1.15'
    am_bindir='/usr/local/bin'
    am_datadir='/usr/local/share'
    am_docdir='/usr/local/share/doc/automake'
    am_pkgvdatadir='/usr/local/share/automake-1.15'
    am_scriptdir='/usr/local/share/automake-1.15'
